...
void stack_empty()
{
	...
	calc_time_taken(start, end, "stl_stack.empty()");
}
...
void stack_size()
{
	...
	stack_size_3();
	gettimeofday(&end, NULL);
	calc_time_taken(start, end, "stl_stack.size()");
}
...
void stack_top()
{
	...
	stack_top_1();
	gettimeofday(&end, NULL);
	calc_time_taken(start, end, "stl_stack.top()");
}
...
void stack_push()
{
	...
	stack_push_2();
	gettimeofday(&end, NULL);
	calc_time_taken(start, end, "stl_stack.push()");
}
